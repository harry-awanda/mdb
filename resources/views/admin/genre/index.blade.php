          ...
          <div class="card-header">
            <h4>Genre</h4>
              <div class="card-header-action">
                <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#tambahData">Add Genre</button>
            </div>
          </div>
          <div class="card-body">
            @if(session('berhasil'))
              ...
              <table id="tables" class="table table-hover">
                <thead>                                 
                  <tr>
                    ...
                    <th>TV Show and Movie Genres</th>
                    ...
                    <td align="center">
                      <div class="btn-group" role="group" aria-label="Action">
                        <form action="{{ route('Genre.destroy', $data->id) }}" method="POST">
                          @csrf
                          @method('delete')
                          <a href="{{ route('Genre.edit', $data-> id) }}" class="btn btn-primary btn-sm"><i class="lni lni-pencil"></i><span class="ml-1">Edit</span></a>
...
<div class="modal fade" id="tambahData" tabindex="-1" aria-labelledby="tambahData" aria-hidden="true">
  ...
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="tambahData">Input Genre</h5>
        <div class="right">
      ...
      <form action="{{ route('Genre.store') }}" method="POST">
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            <label for="asal">Kategori</label>
            <input name="name" type="text" class="form-control" id="name" placeholder="Genre">
          </div>
        </div>
